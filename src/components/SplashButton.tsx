...
const ArrowIcon = () => (
  <div className="splash-btn__icon">
    <div />
  </div>
);
...
export function SplashButton({ href, children, className = "", onClick }: SplashButtonProps) {
  const content = (
    <>
      <div className="splash-btn__bg" aria-hidden />
      <SplashSvg />
      <PathSvg />
      <div className="splash-btn__wrap">
        <div className="splash-btn__outline" aria-hidden />
        <div className="splash-btn__content">
          <span className="splash-btn__text">
            {children}
            <ArrowIcon />
          </span>
        </div>
  ...
  if (href) {
    return (
      <Link href={href} className={`splash-btn ${className}`.trim()}>
        {content}
      </Link>
    );
  }
  ...
  return (
    <button type="button" className={`splash-btn ${className}`.trim()} onClick={onClick}>
      {content}
    </button>
  );
}
